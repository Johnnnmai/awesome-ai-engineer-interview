...
- [0-to-1 Playbook: AI Engineer](../playbooks/ai-engineer.md) - end-to-end guide from zero experience to first offer
- [0-to-1 Playbook: ML Engineer](../playbooks/ml-engineer.md) - transitioning from SWE or data science into ML engineering
- [0-to-1 Playbook: MLOps Engineer](../playbooks/mlops-engineer.md) - infrastructure and platform roles for ML systems
- [0-to-1 Playbook: AI Research Engineer](../playbooks/ai-research-engineer.md) - roles at frontier labs requiring implementation depth
- [0-to-1 Playbook: Applied Scientist](../playbooks/applied-scientist.md) - hybrid researcher-engineer roles at product companies
